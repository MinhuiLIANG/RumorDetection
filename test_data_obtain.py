con_corpus_pos = './data/test/test_positive.txt'
senti_corpus_pos = './data/test/positive_senti.txt'
bow_corpus_pos = './data/test/positive_tf.txt'

con_corpus_neg = './data/test/test_negative.txt'
senti_corpus_neg = './data/test/negative_senti.txt'
bow_corpus_neg = './data/test/negative_tf.txt'
...
def test_data_obtain(con_corpus_pos, senti_corpus_pos, bow_corpus_pos, con_corpus_neg, senti_corpus_neg, bow_corpus_neg):
    con_data = []
    label = []
...
def feed_dataset_test():
    content, sentiment, bow, label = test_data_obtain(con_corpus_pos, senti_corpus_pos, bow_corpus_pos, con_corpus_neg, senti_corpus_neg, bow_corpus_neg)
    txts = []
    imgs = []
